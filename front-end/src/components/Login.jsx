...
function Login({ setIsAuthenticated }) {
  ...
  const handleSignIn = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://dresspro-back-end.onrender.com/api/users/login', {
        method: 'POST',
        headers: {
        ...
        <div className="login-toggle-container">
          <div className="login-toggle">
            <div className="login-toggle-panel login-toggle-left">
              ...
              <button className="login-hidden" type="button" onClick={handleLogin}>Sign In</button>
            </div>
            <div className="login-toggle-panel login-toggle-right">
              <h1>Hello, Friend!</h1>
              <p>Register with your personal details to use all of site features</p>
              <button className="login-hidden" type="button" onClick={handleRegister}>Sign Up</button>
            </div>
          </div>
        </div>
      </div>
